...
public class MethodCreation01 {
    ...
    static void carpmaYap(int a, int b) {
    ...
    //methodun return type i void ise method body icinde return keywordu yazilmaz.4


    static void cevre(double k) {
        System.out.println(2 * 3.14 * k);
    }

    public static void alan(double k) {
        System.out.println(3.14 * k * k);
    }
